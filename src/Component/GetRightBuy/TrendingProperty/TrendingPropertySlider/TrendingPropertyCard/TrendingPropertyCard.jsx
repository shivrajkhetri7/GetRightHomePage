                        ...
                        <div class="card-body card-body-imp">
                            ...
                            <div className='row'>
                                <div className='col-md-4  p-1'>
                                    <strong  style={{backgroundColor:'yellow',padding:'5px 10px 5px 10px'}}>Price : 90 Lac Onward's</strong>
                                </div>
                                <div className='col-md-4  p-1'>
                                    <strong style={{backgroundColor:'yellow',padding:'5px 10px 5px 10px'}}>Offer :5% Off</strong>
                                </div>
                                <div className='col-md-4 p-1'>
                                    <strong style={{backgroundColor:'yellow',padding:'5px 10px 5px 10px'}}>Project By :-Sobha </strong>
                                </div>
                            </div>

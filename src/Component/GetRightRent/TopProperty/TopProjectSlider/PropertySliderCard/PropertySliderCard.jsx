            ...
            <div className='sliderCard'>
                <div className='sliderCardBody'>
                    ...
                    <div className='sliderCardTitle mt-1'>
                        <div className='sliderTitle text-left ml-1'>Sobha Dream Acare
                        <br/>
                    ...
                    <div className='sliderCardText mt-1'>
                        ...
                        <div className='row'>
                            <div className='col-md-12'>
                                <div className='ApartmentSize text-left ml-3 '><i class="fas fa-rupee-sign"></i> :  6000
                                    <br />
                                    <small className='text-muted text-left'>Bagalore , HSR Layout</small>
                                </div>
                            </div>
                        </div>
                    </div>
